...
\item[$\bullet$] Microsoft Academic (deprecated) - \url {https://academic.microsoft.com/search?q=ka%20shrinivaasan&qe=%40%40%40Composite(AA.AuN%3D%3D%27ka%20shrinivaasan%27)&f=&orderBy=4&skip=0&take=10}
...
\item[$\bullet$] CiteSeerX (deprecated) - \url {https://citeseerx.ist.psu.edu/search?q=Ka.+Shrinivaasan}    
