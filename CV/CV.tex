...
\item[$\bullet$] CMI Alumni - MSc and JRF Research Scholar - 2010-11 - \url {https://www.cmi.ac.in/about/reports/cmi-annual-report-2010-2011.pdf}
...
\section{AI reviews of Publications, NeuronRain FOSS repositories and some draft publications thereof - 2025-2026}
\begin{enumerate}
\item[$\bullet$] SciSpace AI - \url{https://github.com/shrinivaasanka/asfer-github-code/tree/master/asfer-docs/SciSpaceAIRelatedPapers} \\
\item[$\bullet$] ChatGPT AI review of Google Scholar profile - \url{https://github.com/shrinivaasanka/asfer-github-code/blob/master/asfer-docs/ChatGPT_AI_Review_of_GoogleScholarProfile.pdf} \\
\item[$\bullet$] ChatGPT AI review of Computational Geometric Factorization in NeuronRain FOSS - \url{https://github.com/shrinivaasanka/asfer-github-code/blob/master/asfer-docs/ChatGPT_review_of_ComputationalGeometricFactorizationAlgorithm.pdf} \\
\item[$\bullet$] ChatGPT AI review 2 of Computational Geometric Factorization in NeuronRain FOSS - \url{https://github.com/shrinivaasanka/asfer-github-code/blob/master/asfer-docs/ChatGPT_review2_of_ComputationalGeometricFactorizationAlgorithm.pdf} \\
\item[$\bullet$] ChatGPT AI review of NeuronRain FOSS - \url{https://github.com/shrinivaasanka/asfer-github-code/blob/master/asfer-docs/ChatGPT_AI_codereview_of_NeuronRain_repositories.pdf} \\
\item[$\bullet$] Claude AI review of NeuronRain FOSS - \url{https://github.com/shrinivaasanka/asfer-github-code/blob/master/asfer-docs/Claude%20AI%20code%20review%20of%20NeuronRain.pdf}
\end{enumerate}
...
\begin{enumerate}
\item[$\bullet$] $NeuronRain \quad Research$ - \url {http://sourceforge.net/users/ka_shrinivaasan} \\
\item[$\bullet$] $NeuronRain \quad Green$ - \url {https://github.com/shrinivaa sanka/} \\
\item[$\bullet$] $Krishna \quad iResearch \quad GitHub \quad Organization$ - \url {https://github.com/Krishna-iResearch} \\
\item[$\bullet$] $Krishna \quad iResearch \quad TLD $ - \url {http://www.krishna-iresearch.org/} \\
\item[$\bullet$] $NeuronRain \quad Antariksh$ - \url {https://gitlab.com/shrinivaasanka/} \\
\item[$\bullet$] $NeuronRain \quad Documentation, FAQ \quad and \quad Licensing$ - \url {http://neuronrain-documentation.readthedocs.io/en/latest/} \\
\item[$\bullet$] $GitHub \quad pages \quad NeuronRain \quad Documentation, FAQ \quad and \quad Licensing$ - \url {https://shrinivaasanka.github.io/Krishna_iResearch_DoxygenDocs/} \\
\item[$\bullet$] $NeuronRain \quad Features $ - \url {https://github.com/shrinivaasanka/asfer-github-code/blob/3372e4fa8c2b7018d7e4a5cebb29286d992d162e/python-src/NeuronRainFeatures.txt} \\
\end{enumerate}
