...
\item[$\bullet$] B.E(Computer Science)-PSG College of Technology,Coimbatore- 1995-99
...
\section{Advisors and Publications Co-Authors - CMI/IMSc/IIT, Chennai}
\begin{enumerate}
...
\item[$\bullet$] CMI - \url {https://www.cmi.ac.in/people/alumni-profile.php?id=shrinivas}
\end{enumerate}
...
Previous repositories include an open learning free courseware ( \url {https://github.com/shrinivaasanka/Grafit/tree/master/course_material}) and implementations of publications and drafts in \url {https://sites.google.com/site/kuja27/}.
